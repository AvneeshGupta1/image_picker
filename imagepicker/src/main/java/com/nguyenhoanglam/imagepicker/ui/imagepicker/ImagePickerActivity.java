...
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resourceType = intent.getIntExtra(Config.EXTRA_RESOURCE_TYPE, -1);
        setContentView(R.layout.imagepicker_activity_picker);
        requestCode = intent.getIntExtra(Config.EXTRA_REQUEST_CODE, -1);
        setupView();
        setupComponents();
        setupToolbar();
...
//        }
    ...
    private void setupComponents() {
        recyclerViewManager = new RecyclerViewManager(recyclerView, resourceType, config, getResources().getConfiguration().orientation);
        ...
        presenter = new ImagePickerPresenter(new ImageFileLoader(this), resourceType);
    ...
    private void captureImage() {
        ...
        presenter.captureImage(this, config, requestCode);
    }
