...
public class ImagePickerPresenter extends BasePresenter<ImagePickerView> {
    ...
    public ImagePickerPresenter(ImageFileLoader imageLoader, int resourceType) {
    ...
    public void loadImages(boolean isFolderMode) {
        ...
        imageLoader.loadDeviceImages(isFolderMode, resourceType, new OnImageLoaderListener() {
            @Override
