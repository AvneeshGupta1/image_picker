...
public class RecyclerViewManager {
    ...
    public RecyclerViewManager(RecyclerView recyclerView, int resourceType, Config config, int orientation) {
    ...
    public void setupAdapters(OnImageClickListener imageClickListener, final OnFolderClickListener folderClickListener) {
        ...
        imageAdapter = new ImagePickerAdapter(context, resourceType, imageLoader, selectedImages, imageClickListener);
